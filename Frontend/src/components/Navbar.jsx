        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <NavLink to="/" className="flex ms-2 md:me-24">
                <img
                  ...
                  alt="FlowBite Logo"
                />
                <span className="self-center text-[1.7rem] font-semibold whitespace-nowrap dark:text-white">
                  BookWise
                </span>
              </NavLink>
            </div>
            ...
            <div className="flex items-center ms-3">
              <div>
                <button
                  className="bg-slate-700 text-white h-9 w-24 rounded-md hover:bg-slate-900"
                  onClick={(e) => {
                    e.preventDefault();
                    setIsLogin(!isLogin);

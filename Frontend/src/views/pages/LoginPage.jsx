...
const LoginPage = () => {
    ...
    const {isLogin, setIsLogin, setAdminemail} = useLoginContext();
            ...
            <section className="text-gray-600 body-font h-full flex bg-[url('./loginbg.jpg')] bg-cover bg-center">
                ...
                <div className="w-full lg:px-20 py-24 mx-auto flex flex-wrap items-center " style={{
                    ...
                    <div className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                        ...
                        <button className="text-white bg-yellow-400 border-0 py-2 px-8 mt-2 focus:outline-none hover:bg-yellow-500 rounded text-lg" onClick={(e) => {
                            checkdetail(e);
                        }}>Login</button>
